...
GOF_PUBLIC_AI_ASSISTANT_ENABLED = env_bool('GOF_PUBLIC_AI_ASSISTANT_ENABLED', GOF_AI_ENABLED)
GOF_PUBLIC_AI_ASSISTANT_MODEL = (
    os.environ.get('GOF_PUBLIC_AI_ASSISTANT_MODEL', GOF_AI_MODEL).strip() or GOF_AI_MODEL
)
GOF_PUBLIC_AI_ASSISTANT_MAX_INPUT_CHARS = int(os.environ.get('GOF_PUBLIC_AI_ASSISTANT_MAX_INPUT_CHARS', '500'))
GOF_PUBLIC_AI_ASSISTANT_MAX_OUTPUT_TOKENS = int(os.environ.get('GOF_PUBLIC_AI_ASSISTANT_MAX_OUTPUT_TOKENS', '250'))
GOF_PUBLIC_AI_ASSISTANT_MAX_MESSAGES_PER_IP_PER_HOUR = int(
    os.environ.get('GOF_PUBLIC_AI_ASSISTANT_MAX_MESSAGES_PER_IP_PER_HOUR', '5')
)
GOF_PUBLIC_AI_ASSISTANT_MAX_MESSAGES_PER_IP_PER_DAY = int(
    os.environ.get('GOF_PUBLIC_AI_ASSISTANT_MAX_MESSAGES_PER_IP_PER_DAY', '20')
)
GOF_SITE_STATUS = os.environ.get('GOF_SITE_STATUS', 'open').strip().lower() or 'open'
